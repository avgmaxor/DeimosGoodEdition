...
public class FakePlayer
    ...
    private static final String[] fitInfo = new String[]{"d0dc99f7-ec1b-424e-a30a-6c35d7a37a2c", "furriesarehot"};
    ...
    public FakePlayer() {
        super("FakePlayer", "Spawns in a client sided fake player", Module.Category.PLAYER, true, false, false);
        this.setInstance();
    }
